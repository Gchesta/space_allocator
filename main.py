...
Usage:
    ...
    sophia add_person <first_name> <other_names>... (<fellow>|<staff>) [<wants_accomodation>]
...
Arguments:
    <room_name>                 Choose between a livingspace and an office
    <room_name>                 The name of the room to create
    <first_name>                First name of the new person
    <other_names>               Other names of the new person
...
class Start(cmd.Cmd):
    ...
    def do_create_room(self, args):
        ...
        rundojo.create_room(args)

    @docopt_cmd
    def do_add_person(self, args):
        """usage: add_person <first_name> <other_names>... (<fellow>|<staff>) [<wants_accomodation>]"""
        rundojo.add_person(args)
